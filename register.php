...
<html lang="en">
  <head>
    ...
    <title>NotesHive|Register</title>
    <style>
      .container2 {
  display: flex;
  ...
  <?php
    ...
    <div class="container">
      <form action="" method="post">
         <h3 style="color:white">Register to Use NotesHive <a href="index1.php"></a></h3>
         ...
         <p>Already have a Account? <br> <a class="link" href="login.php">Login</a><a class="link" href="index1.php">Back</a></p>
      </form>
    </div>
