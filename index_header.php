...
<body>
  <header>
    <div class="logo">
        <a href="index1.php"><img src="./images/logo.png" width="50%"></a>
    </div>
    <div class="nav">
        ...
        <div class="dropdown">
            ...
            <a href="http://localhost/noteshive/index1.php#New">New Arrived</a>
                <a href="http://localhost/noteshive/index1.php#Notes">Notes</a>
                <a href="http://localhost/noteshive/index1.php#CheatSheet">CheatSheet</a>
                <a href="http://localhost/noteshive/index1.php#Books">Books</a>
            </div>
        </div>
...
<div class="sub-menu-wrap" id="subMenu">
  <div class="sub-menu">
    ...
    <hr />
    <a href="my_downloads.php" class="sub-menu-link">
      <p>My Downloads</p>
      <span>></span>
    </a>
