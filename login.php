...
<head>
    ...
    <title>NotesHive|Login Here</title>
    <style>
        .container form .link {
...
<body>
    ...
    <div class="container">
        <form action="" method="post">
            <h3 style="color:white">login to <a><img src="./images/logo.png" width="175px 0" ;></a></h3>
            ...
            <p>Don't have an Account? <br> <a class="link" href="Register.php">Sign Up</a><a class="link" href="index1.php">Back</a></p>
        </form>
    </div>
